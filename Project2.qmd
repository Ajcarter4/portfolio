...
Since I got my probabilities, I then grouped my data by model and fold to calcuate my brier scores, and the standard error of my brier scores.
...
flower_class_predictions2 |>
  ...
  scale_fill_manual(
    values = c("Correct" = "#90EE90",  # Light green (hex code)
