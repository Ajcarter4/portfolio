...
The data I looked into in this project is from the Centers for Medicare and Medicaid [Website](https://data.cms.gov/provider-data/dataset/dgck-syfz#data-dictionary). The data set is a listing of various questions and ways of rating hospitals. This includes star ratings, answers percentages, and mean score which contribute to how well rated patients rate a hospital. Initially what I wanted to explore with this hospital data set was ............... QUESTION
...
I made a similar scatter plot for all 3 over my models, only changing the data in my code.
...
geom_histogram()+
  labs(title = "Histogram with Count Labels") 
```

I also made a similar histograms for all 3 over my models, only changing the data in my code for each.
...
```{r}
 ...
 hmeanc_pred2 |> 
  ...
  hmeanc_pred3 |> 
  mutate(rmse3 = sqrt(mean(.resid^2)))|>
   select(rmse3)
```
